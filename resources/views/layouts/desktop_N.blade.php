...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a class="d-block">Witaj Nauczycielu!</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('/class_N&O') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('class&O-form').submit();">
              <i class="nav-icon fas fa-edit"></i> 
              <p>{{ __('Oceny') }}</p>
            </a>
            <form id="class&O-form" action="{{ url('/class_N&O') }}" method="POST">
              @csrf
            </form>
          </li>

          <li class="nav-item">
            <a href="{{ url('/class_N&P') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('class&P-form').submit();">
              <i class="nav-icon fas fa-user-check"></i> 
              <p>{{ __('Obecność') }}</p>
            </a>
            <form id="class&P-form" action="{{ url('/class_N&P') }}" method="POST">
              @csrf
            </form>
          </li>
          <li class="nav-item">
            <a href="{{ url('/class_N&U') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('class&U-form').submit();">
              <i class="nav-icon fas fa-exclamation"></i>
              <p>{{ __('Uwagi') }}</p>
            </a>
            <form id="class&U-form" action="{{ url('/class_N&U') }}" method="POST">
              @csrf
            </form>
          </li>
