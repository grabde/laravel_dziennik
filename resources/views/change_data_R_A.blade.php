      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Zmiana danych</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form id="userForm" action="/update_R" method="POST">
            <!-- /.card-header -->
            <div class="card-body table-responsive p-0">
              <table class="table table-hover text-nowrap">
                <tbody>
                    ...
                    <tr>
                        <td><label for="child" class="col-md-4 col-form-label text-md-right">{{ __('Dziecko') }}</label></td>
                        <td>
                            <select name="child" class="col-md-4 col-form-label text-md-right form-control" required>
                                <option value="{{$child[0]->id}}">{{$child[0]->id}} {{$child[0]->name}} {{$child[0]->surname}}</option>
